        ...
        <section className="farmacia-page fade-in">
          ...
          <div className="card-explicativo">
            ...
            <p>
              ...
              medicamentos são organizados em diferentes componentes, de acordo
              com o tipo de tratamento, a complexidade das doenças e as
          ...
          <p>
            ...
            para o tratamento das doenças mais comuns. Eles fazem parte da
            Relação Municipal de Medicamentos Essenciais (REMUME).
          </p>

          <h4>Quem pode retirar</h4>
          <p>
            Pacientes com receita médica válida e que atendem aos critérios de
            uso de medicamentos disponíveis na rede pública.
          </p>
          ...
          <p>
            Programa do SUS que garante acesso a medicamentos de alto custo
            usados em tratamentos ambulatoriais, seguindo critérios dos
          ...
          <ul className="farmacia-lista-check">
            ...
            <li>
              Atenção: o último dia de atendimento operacional do mês é o dia
              23;
            </li>
            <li>
              Retirada permitida apenas pelo paciente cadastrado ou
              representante legal documentado.
            </li>
          </ul>
          ...
          <div className="nota-informativa-destaque">
            ...
            <p>
              <strong>Atenção ao Cadastro:</strong> Para o Componente
              Especializado, é necessário que o paciente esteja rigorosamente
              enquadrado nos critérios dos PCDTs, apresentando diagnóstico
              laudado e documentação específica exigida pelo Estado.
            </p>
          </div>

          <h3>Componente Estratégico (CESAF)</h3>
          <p>
            Reúne medicamentos para prevenção, controle e tratamento de doenças
            de impacto epidemiológico. A dispensação é realizada diretamente no
            setor de Epidemiologia, mediante receita médica, preenchimento de
            formulários e exames de monitoramento exigidos.
          </p>
        </section>
      </div>
    </main>
