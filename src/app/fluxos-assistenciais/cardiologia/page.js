...
const CONTEUDOS = {
  ...
  Cateterismo: {
    ...
    mas é muito importante seguir todas as orientações antes do procedimento.`,
    imagens: [
  ...
  Cirurgia: {
    ...
    É como se fizessem uma nova estrada para o sangue passar sem dificuldade. 
    Esse procedimento é conhecido como "ponte de safena" quando usam uma veia da perna. 
    Outra cirurgia cardíaca é para a troca de válvula, que é feita quando uma das válvulas do coração não está funcionando direito. 
    As válvulas são como “portinhas” dentro do coração que controlam a passagem do sangue. 
  ...
  Eletrofisiologia: {
    ...
    especialmente quando ele bate muito rápido, muito devagar ou de forma descompassada (as famosas arritmias). 
    Nesse tipo de procedimento, os médicos colocam fios fininhos (chamados cateteres) dentro do coração, através de uma veia, 
    para estudar como está passando a eletricidade que comanda os batimentos. 
    Se for preciso, eles podem fazer um tratamento chamado ablação, que “queima” ou “desativa” o ponto do coração que está causando a arritmia. 
    Em alguns casos, há necessidade de colocar o marcapasso. O marca-passo é um aparelhinho que ajuda o coração a bater no ritmo certo. 
